		  ...
		  <div class="collapse navbar-collapse" id="navbarmain">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
			   ...
			   <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="{{route('front.blog-sidebar')}}" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog <i class="icofont-thin-down"></i></a>
